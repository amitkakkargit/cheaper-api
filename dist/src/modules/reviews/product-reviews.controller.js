...
let ProductReviewsController = class ProductReviewsController {
    ...
    create(user, createProductReviewDto) {
        return this.reviewsService.createProductReview(user.userId, createProductReviewDto);
    }
    findByProduct(productId, user) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, create_product_review_dto_1.CreateProductReviewDto]),
    __metadata("design:returntype", void 0)
], ProductReviewsController.prototype, "create", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], ProductReviewsController.prototype, "findByProduct", null);
